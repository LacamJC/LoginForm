...
<html lang="pt-BR">
  ...
  <body>
      ...
      <form class='form__form my-5' method='GET' action='verficaLogin.php'>
          ...
          <div class='mb-3'>
              ...
              <label for="checkOcult" class="form__label">Mostrar Senha</label> <input type="checkbox" name="" id="checkOcult">
          </div>
